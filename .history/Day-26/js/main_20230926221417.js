...
function displayLyrics() {
  // Xử lý dữ liệu và hiển thị lời bài hát
  var lyricsText = "";

  // Duyệt qua từng câu trong dữ liệu
  lyricsData.data.sentences.forEach(function (sentence) {
    // Duyệt qua từng từ trong câu
    sentence.words.forEach(function (word) {
      // Thêm từ vào lời bài hát
      lyricsText += word.data + " ";
    });
