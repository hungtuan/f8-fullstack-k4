  ...
  renderPosts: async function () {
    ...
    if (response.ok) {
      ...
      posts.data.forEach(function (post) {
        ...
        const minutesCurrent = Math.floor(minutesDifference);
        const hoursDifference = Math.floor(hoursDifference);
      ...
      <div class="post">
          <div class="time">
              <div class="time-detail">
                  <span class="preiod">
                      <span>${hoursCurrent} giờ trước</span>
                  </span>
                  <div class="time-post">
                      <span class="hours">${hoursCurrent}h sáng</span>
                       <span class="minutes">${minutesCurrent} phút</span>
                  </div>
              </div>
