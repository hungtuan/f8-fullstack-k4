...
const app = {
  ...
  render: function () {
    ...
    if (this.isLogin()) {
      ...
      this.renderPosts().then((resultPosts) => {
        console.log(resultPosts);

        // Khi promise của renderPosts đã hoàn thành, xử lý kết quả và cập nhật biến html
        html = `${this.goHomePage()} ${resultPosts}`;
        console.log(html);

        // Gán nội dung HTML vào phần tử this.root
