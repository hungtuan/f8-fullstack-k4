...
const app = {
  ...
  loading: function (status = true) {
    ...
    const buttonRegister = this.root.querySelector(".register .btn");
    ...
    if (buttonRegister) {
      if (status) {
        buttonRegister.innerHTML = `<span class="spinner-border spinner-border-sm"></span> Loading...`;
        buttonRegister.disabled = true;
      } else {
        buttonRegister.innerHTML = `Đăng ký`;
