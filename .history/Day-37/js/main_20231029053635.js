  ...
  signUp: async function (userdata) {
    try {
      ...
      if (response.ok) {
        ...
        // Hiển thị thông báo đăng ký thành công cho người dùng ở đây, ví dụ: thông báo trên trang web.
      } else {
        // Đăng ký thất bại, xử lý lỗi
        console.error("Đăng ký thất bại:", data.message);
        // Hiển thị thông báo lỗi cho người dùng ở đây, ví dụ: thông báo lỗi trên trang web.
      }
    } catch (e) {
