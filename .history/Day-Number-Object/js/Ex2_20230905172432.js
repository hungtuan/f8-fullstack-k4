...
Object.prototype.getCurrency = function (currency) {
  ...
  // Chuyển giá trị thành chuỗi và toLocaleString chuyển nó thành hàng nghìn
  let formattedValue = Number(this).toLocaleString(undefined, {
...
//Case 1
var price = 12000;
console.log(typeof price.getCurrency("đ"));
