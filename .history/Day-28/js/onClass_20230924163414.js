...
// JSON
// Giao tiếp dữ liệu giữa các nền tán
// Mổ tả dữ liệu
// JSON là chuỗi

// Khi làm việc
// Chuyển từ các kiểu dữ liệu -> JSSON

// console.log(JSON.stringify(variable));

// Chuyển từ các JSON -> Dư liệu
// JSON.parse(variable);
var users = [
  {
    id: 1,
...
// Check JSON
if (JSON.isRawJSON(json)) {
  console.log("Đúng là JSON");
} else {
  console.log("Không đứng");
}
